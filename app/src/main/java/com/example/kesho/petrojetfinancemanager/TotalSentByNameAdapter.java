...
/**
 * Created by kesho on 3/27/2018.
 */

public class TotalSentByNameAdapter extends ArrayAdapter<Order> {
    ...
    public TotalSentByNameAdapter(@NonNull Activity context, int resource, @NonNull List<Order> objects) {
