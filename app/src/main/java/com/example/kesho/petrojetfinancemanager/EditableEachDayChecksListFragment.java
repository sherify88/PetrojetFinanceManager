 ...
 */
public class EditableEachDayChecksListFragment extends android.app.Fragment {
    ...
    EachDayCheckAdapter arrayAdapter;
    Order order;
    ...
    public EditableEachDayChecksListFragment() {
        ...
        valueEventListener=mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    arrayAdapter=new EachDayCheckAdapter(getActivity(),R.layout.response_list_item, orders);
