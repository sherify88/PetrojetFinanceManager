 ...
 */
public class DefineOnlyDatesForChecksFragment extends android.app.Fragment {
    ...
    public DefineOnlyDatesForChecksFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_define_only_dates_for_checks, container, false);
        ...
        final String string=bundle.getString(TreasuryChecksAdapter.CHECK_NUMBER_AS_A_KEY);
        ...
        vendorNameTxtView.setText(" رد علي طلب استلام شيك رقم : "+ string + "  بقيمة  " + bundle.getString(TreasuryChecksAdapter.AMOUNT_PASSING)  );
...
//                                        String now3 = df3.format(monthId.getText().toString());
                                        ...
                                        ordersDatabase.child("name").setValue(bundle.getString(TreasuryChecksAdapter.NAME_PASSING));
                                        ordersDatabase.child("Amount").setValue(bundle.getString(TreasuryChecksAdapter.AMOUNT_PASSING));
                                        ordersDatabase.child("vendor").setValue(bundle.getString(TreasuryChecksAdapter.VENDOR_PASSING));
                    ...
                    ordersDatabase.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                ...
                                try {
                                    editpass = Double.parseDouble(bundle.getString(TreasuryChecksAdapter.AMOUNT_PASSING));
                                } catch (NumberFormatException e) {
                                    e.printStackTrace();
                                }
